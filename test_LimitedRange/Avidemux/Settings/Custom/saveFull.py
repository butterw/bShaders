...
# also displays some extra info in the title of the save dialog (duration in minutes, nbSegments / nbVideos)
# this script can be installed to settings/custom GUI menu

header_str = "saveFull" # by butterw, tested in Avidemux2.7.7 
